# Swarm deployment commands for Empiria website
...
deploy: build
    swarm-cli feed upload ./public \
      --identity empiria-website \
      --topic-string "empiria-website-main" \
...
verify:
    swarm-cli feed print --identity empiria-website --topic-string "empiria-website-main"
    echo ""
    echo "Testing local access..."
    curl -s http://r2d2:1633/bzz/$SWARM_FEED_MANIFEST/ | head -20
    echo ""
    echo "Testing gateway access..."
    curl -s -I https://empiria.eth.limo | head -5
